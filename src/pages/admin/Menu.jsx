import { Table, Space, message, Button, Spin, Modal } from "antd";
...
const Menu = () => {
  ...
  const confirmDelete = () => {
    axios
      .delete(`${import.meta.env.VITE_BACKEND_URL}/api/menu/${deleteItemId}`, {
        headers: {
          Authorization: token,
      ...
      .then(() => {
        ...
        setItemAdded(!itemAdded); // Refresh the menu items
      })
      .catch((err) => {
